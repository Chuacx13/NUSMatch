...
1. Proposed Level of Achievement	3
2. Motivation	3
3. Aim	4
4. User Stories	5
5. Features	6
5.1. Authentication Interface (Completed)	6
5.2. Profile (Not Done)	6
5.3. Groups (Not Done)	7
5.4. Search Function (Not Done)	7
5.5. Chat Function (Not Done)	8
5.6. Algorithm (Not Done)	8
5.7. Scheduling Interface (Not Done)	8
5.8. Database (Not Done)	9
6. Timeline	10
7. Tech Stack	12
